((auto-complete status "installed" recipe
 ...
 (project-root status "installed" recipe
               (:name project-root :website "http://solovyov.net/project-root/" :description "Project-root is a simple project management tool for Emacs, which provides certain flexibility when defining projects." :type hg :url "http://hg.piranha.org.ua/project-root/" :features project-root))
 ...
 (shell-current-directory status "installed" recipe
                          (:name shell-current-directory :description "Create new shell based on buffer directory" :type github :pkgname "metaperl/shell-current-directory" :features shell-current-directory))
